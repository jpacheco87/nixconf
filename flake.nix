  ...
  in
    with myLib; {
      ...
      homeConfigurations = {
        ...
        "jpacheco@laptop" = mkHome "x86_64-linux" ./hosts/laptop/home.nix;
        "jpacheco@work" = mkHome "x86_64-linux" ./hosts/work/home.nix;

        # ========================= Discontinued ========================= #
        # This one doesn't work. Left it in case I ever want to use it again

        "jpacheco@osxvm" = mkHome "x86_64-darwin" ./hosts/osxvm/home.nix;
      };
